...
export const WithCounter: Story = {
  render: () => <WithCounterDemo />,
};

/**
 * Textarea with character counter and helper text.
 */
function WithCounterAndHelperDemo() {
  const [value, setValue] = useState('');
...
export const WithCounterAndHelper: Story = {
  render: () => <WithCounterAndHelperDemo />,
};
...
export const ErrorStates: Story = {
  render: () => (
    <div className="space-y-4 w-80">
      <Textarea placeholder="Message" error="Message is required" />
      <Textarea
