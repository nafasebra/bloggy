...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed lg:static inset-y-0 left-0 z-40 flex h-full w-64 flex-col bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-transform duration-300',
