...
import { usePosts } from '@/hooks/query';
              ...
              <Table>
                ...
                <TableBody>
                  {[1, 2, 3, 4, 5].map((i) => (
                    <TableRow key={i}>
                      <TableCell>
                        <div className="h-5 max-w-[240px] bg-muted rounded animate-pulse" />
                      </TableCell>
                      ...
                      <TableCell className="text-right">
                        <div className="h-8 w-16 ml-auto bg-muted rounded animate-pulse" />
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
