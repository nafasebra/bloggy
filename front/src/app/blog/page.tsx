...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "Learn how to cook delicious meals while reducing your environmental impact. From farm-to-table recipes to zero-waste cooking techniques.",
    author: "Emma Davis",
    authorId: 3,
    date: "2024-01-13",
  ...
  },
  {
    ...
    excerpt: "Master the techniques of capturing stunning travel photos that tell stories and preserve memories of your adventures around the world.",
  ...
  },
  {
    ...
    excerpt: "A comprehensive guide to designing and implementing robust, scalable APIs using Node.js and modern development practices.",
    author: "David Kim",
    authorId: 5,
    date: "2024-01-11",
  ...
  },
  {
    ...
    excerpt: "Everything you need to know about working remotely while traveling the world, from productivity tips to finding the best coworking spaces.",
    author: "Lisa Wang",
    authorId: 6,
    date: "2024-01-10",
    readTime: "9 min read",
